...
Named body. The specific board or committee holding climate responsibility, with climate in its stated remit.
Frequency. How often it considers climate: a meeting count, a stated cadence, a number of times in the period. Not "regularly" or "as required".
Substance. At least one climate matter the body reviewed, approved or decided this period. Approved the targets, endorsed the transition plan, reviewed scenario results, weighed climate in a named capital decision.
...
2	All three elements.
Named role or committee. A specific executive position or management committee. Not "management" or "the sustainability team".
Reporting line. How it reports to the board, or to which board committee.
What it does. How management is informed, or how it monitors. A list of responsibilities is not a process.
...
2	All four elements.
Horizons in years. Short, medium and long term each given a period.
Specific physical risks. Named hazards, named assets, operations or regions. "Extreme weather" is not specific.
Specific transition risks. Named policy, legal, technology, market or reputational risks. "Regulatory change" is not specific.
Opportunities, and risks mapped to horizons. Which risks and opportunities fall in which horizon.
...
2	All three elements.
Named business areas. Products and services, supply chain, operations, adaptation and mitigation, research and development.
Named financial planning dimension. Operating costs, revenues, capital expenditure and allocation, acquisitions or divestments, asset values or useful lives, provisions, access to capital.
A specific consequence. A quantified figure, or a named decision taken or planned: a named capital programme, an asset written down, a divestment. Saying climate is factored into planning without naming what came out of it does not satisfy this.
...
2	All four elements.
Two scenarios, one at 1.5°C. The Australian rules require at least two, one consistent with 1.5°C and one with higher warming (AASB, 2024).
Named, with source. NGFS, IEA, IPCC SSPs, or equivalent.
Scope and horizon. Which parts of the business, over what period.
Differentiated findings. Results that differ between scenarios. One conclusion of resilience, identical across scenarios, does not satisfy this.
...
2	All three elements.
Who and how often. The function or body doing it, and the frequency.
How significance is determined. A likelihood and impact scale, a scoring method, a threshold, or a materiality definition applied to climate.
Inputs. Regulatory requirements, scenario outputs, asset-level hazard data, value chain information.
...
2	Both elements.
Decision logic. How the company chooses between mitigating, transferring, accepting and controlling a climate risk.
A named risk linked to a named response. One identified risk paired with the action taken against it this period. The disclosure has to make the connection; a list of initiatives elsewhere in the report does not.
...
2	All three elements.
Named framework. The enterprise risk framework, policy or register climate sits within.
Shared machinery. Same materiality thresholds, escalation paths or reporting channels as other risks, rather than a parallel process.
Evidence in the period. Climate appears as a named principal or material risk in the company's own risk disclosure.
...
2	All three elements.
Breadth. Metrics from at least two of the seven cross-industry categories other than GHG emissions. The categories are in Appendix 2, Table A2.1 of the 2021 Annex, covering transition risk, physical risk, opportunities, capital deployment, internal carbon prices and remuneration alongside emissions (TCFD, 2021a; 2021b). I read Table A2.1 when classifying rather than working from memory.
Definition or basis of preparation. So the reader knows what was counted.
Comparability. A prior-year comparative or stated baseline for each metric.
...
2	All four elements.
Scope 1 and 2 with figures, Scope 2 identified as location-based, market-based, or both.
Scope 3 with figures, by GHG Protocol category. A single undifferentiated total does not satisfy this.
Basis of preparation. Methodology, boundary or emission factor source, in the disclosure or a referenced document.
Prior-year comparatives for each scope reported.
...
2	All four elements.
An interim target dated 2035 or earlier, with a stated base year. A 2050 net zero aspiration alone does not satisfy this.
Scope and type. Which emissions scopes, and absolute or intensity-based.
Quantified progress. Performance against the interim target as a figure for this period. "On track" without a number does not satisfy this.
Linked to a disclosed metric, so progress can be traced.
...
Transition: BHP, BSL, EVN, FMG, JHX, LYC, NEM, NST, PLS, RIO, S32, STO, WDS, ORG, APA, QAN. Physical: GPT, SGP, GMG, SCG, TCL, COL, WOW, BXB. Indirect: ANZ, CBA, NAB, WBC, ASX, MQG, SOL, IAG, QBE, SUN. Baseline: TLS, CAR, WES, ALL, LNW, TLC, CSL, COH, RMD, SHL, SIG, MPL, ALQ, CPU, WTC, XRO.
